...
fin = open("/mnt/data1/dev/data/book/book.txt", encoding="iso-8859-1")
flines = open("/mnt/data1/dev/data/book/book_lines.txt", "w")
fout = open("/mnt/data1/dev/data/book/book_06.txt", "w")
...
if __name__ == "__main__":
    ...
    lines = filter(lines, [strategyLen, strategyCharRatio])
    writeRes(lines)
